...
public class UsersController extends BfAbsUserController {
    ...
    public ResponseEntity checkTokenExpired(HttpServletRequest httpServletRequest) throws Exception {
        return ResponseUtil.sendResponse(!userJwtService.checkTokenExpired(httpServletRequest));
    }
    ...
    public ResponseEntity regenerateToken(
        ...
        HttpServletRequest httpServletRequest) throws Exception {        
        return ResponseUtil.sendResponse(userJwtService.generateTokenByRefreshToken(refresh_token));
    }
}
