...
import com.binoofactory.cornsqure.web.repos.jpa.ImportPaymentRepos;
...
public class ImportServiceImpl implements ImportService {
    ...
    @Autowired
    public ImportServiceImpl(UserAuthService userAuthService, UserJwtService userJwtService,
    ...
    public String generateOrderNumber(ImportPayment payment, HttpServletRequest httpServletRequest) throws Exception {
        // 고객 주문번호 생성(채번)
        Users loginUser = userJwtService.getUserInfoByToken(httpServletRequest);
