...
public class UserServiceImpl implements UserService {
    ...
    public Users findMe(HttpServletRequest httpServletRequest) {
        Users userInfos = jwtService.getUserInfoByToken(httpServletRequest);
    ...
    @Override
    public Token login(Users user, HttpServletRequest httpServletRequest) throws Exception {
        ...
        Token token = jwtService.generateToken(userInfos, template);
    ...
    @Override
    public Token snsLogin(String snsValue, SNSType snsType, HttpServletRequest httpServletRequest) throws Exception {
